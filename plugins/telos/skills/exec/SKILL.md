...
2. **Verifica que existe una ficha de propósito** para la tarea actual. Si no existe o es ambigua, formula una breve (funcional + restricción como mínimo) antes de implementar.
